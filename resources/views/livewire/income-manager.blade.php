...
new #[Layout('layouts.app')] class extends Component {
    ...
    public $newCategoryColor = 'bg-indigo-500';
    ...
    public function mount(): void
    {
        ...
        $defaultCat = $this->categoryService->getByType(auth()->id(), 'income')->first();
        if ($defaultCat) {
    ...
    public function saveCategory(): void
    {
        ...
        $cat = $this->categoryService->create(auth()->id(), 'income', [
    ...
    public function save(): void
    {
        ...
        $this->transactionService->createIncome(auth()->id(), [
            'amount'           => $this->amount,
    ...
    {
        return [
            'transactions' => $this->transactionService->getIncome(auth()->id()),
            'categories'   => $this->categoryService->getByType(auth()->id(), 'income'),
        ];
    }
}; ?>
